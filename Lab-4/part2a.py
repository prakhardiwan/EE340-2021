...
class part2a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._mult_in_k_range = Range(0.01, 1.01, 0.1, 0.01, 200)
        self._mult_in_k_win = RangeWidget(self._mult_in_k_range, self.set_mult_in_k, 'interferer_amplitude', "slider", float)
        self.top_grid_layout.addWidget(self._mult_in_k_win)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(20)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/prakhar/Desktop/EE_340/Lab-4/Input.bin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 45000, mult_in_k, 0, 0)
        ...
        self.connect((self.blocks_file_source_0, 0), (self.qtgui_sink_x_0_0_0, 0))
    ...
    def get_mult_in_k(self):
        return self.mult_in_k

    def set_mult_in_k(self, mult_in_k):
        self.mult_in_k = mult_in_k
        self.analog_sig_source_x_0.set_amplitude(self.mult_in_k)
