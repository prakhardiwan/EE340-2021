...
class Task1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.blocks_vector_source_x_0 = blocks.vector_source_f((261,261,293,261,349,329,261,261,293,261,392,349,261,261,271,440,349,329,293,466,466,440,349,392,349), True, 1, [])
