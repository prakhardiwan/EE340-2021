...
class task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iir_filter_xxx_0_0 = filter.iir_filter_ccf([1], [1, -0.3], True)
        self.iir_filter_xxx_0 = filter.iir_filter_ccf([1], [1, -0.3], True)
        ...
        self.connect((self.iir_filter_xxx_0_0, 0), (self.blocks_throttle_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 30000, 1000, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 30000, 1000, firdes.WIN_HAMMING, 6.76))
