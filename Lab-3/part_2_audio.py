...
class part_2_audio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "part_2_audio")
        ...
        # Variables
        ##################################################
        self.samp_rate_msg = samp_rate_msg = 48000
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('D:\\OneDrive - Indian Institute of Technology Bombay\\Desktop\\SEM6\\EE 340 (L)\\Lab-3\\Bach.wav', True)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.audio_sink_0 = audio.sink(48000, '', True)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 400000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 400000, 1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_sink_x_0_0_0, 0))
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.qtgui_sink_x_0_0, 0))
        self.connect((self.hilbert_fc_0, 0), (self.rational_resampler_xxx_1, 0))
        self.connect((self.low_pass_filter_0, 0), (self.audio_sink_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_sink_x_0_0_0_0, 0))
...
def main(top_block_cls=part_2_audio, options=None):
