...
class part_0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "part_0")
        ...
        # Variables
        ##################################################
        self.samp_rate_msg = samp_rate_msg = 32000
        ...
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(75000*6.28)
...
def main(top_block_cls=part_0, options=None):
