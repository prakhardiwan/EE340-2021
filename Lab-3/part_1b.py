...
class part_1b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "part_1b")
        ...
        self.connect((self.dc_blocker_xx_0, 0), (self.qtgui_sink_x_0_0, 0))
...
def main(top_block_cls=part_1b, options=None):
