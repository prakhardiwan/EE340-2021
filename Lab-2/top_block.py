...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tab.addTab(self.tab_widget_1, 'demod')
        ...
        self.msg = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, 1, 0, 0)
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, 32000*30,True)
        ...
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(6.28*75000)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_phase_modulator_fc_0, 0), (self.blocks_multiply_xx_1, 0))
        ...
        self.connect((self.msg, 0), (self.blocks_throttle_0_0, 0))
        self.connect((self.msg, 0), (self.iir_filter_xxx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(3.75, self.samp_rate, 15000, 2000, firdes.WIN_HAMMING, 6.76))
        self.msg.set_sampling_freq(self.samp_rate)
    ...
    def set_fm(self, fm):
        self.fm = fm
        self.msg.set_frequency(self.fm)
