...
class task_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "task_4")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'D:\\OneDrive - Indian Institute of Technology Bombay\\Desktop\\SEM6\\EE 340 (L)\\Lab-2\\lab2_task4.dat', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 15000, 100, firdes.WIN_HAMMING, 6.76))





def main(top_block_cls=task_4, options=None):
